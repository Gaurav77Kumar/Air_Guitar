...
def generate_string_sound(freq, duration=0.6, decay=0.994):
...
VIRTUAL_STRINGS = [
    {"angle": -40, "note": "Low E", "sound": generate_string_sound(82.41)},  # sa
    {"angle": -25, "note": "A",     "sound": generate_string_sound(110.00)},  # ra 
    {"angle": -10, "note": "D",     "sound": generate_string_sound(146.83)},  # ga
    {"angle": 5,   "note": "G",     "sound": generate_string_sound(196.00)}, # ma
    {"angle": 20,  "note": "B",     "sound": generate_string_sound(246.94)}, # pa
    {"angle": 35,  "note": "High E","sound": generate_string_sound(329.63)}, # dha
]
